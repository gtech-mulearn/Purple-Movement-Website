...
const Manifesto = () => {
    ...
    return (
        <div className="flex flex-col min-h-screen w-full text-white px-4 relative sm:py-16">
            <div>
                <Title />
                <Box className="my-16">We are not waiting for the future. We are building it. <br /> With courage, code, creativity, and community.</Box>
                <ManifestoContent />
                <Box className="mt-10">This is The Purple Movement. <br /> Learning with purpose. Powered by people.</Box>
            </div>
            <div className="w-full flex justify-end sm:absolute bottom-0">
                <img src={char1} className="w-[280px] h-full" />
            </div>
        </div>
        // <d iv className={` grid px-2 gap-2 items-center `}>
...
const Title = () => {
    return (
        <span className=" flex gap-2 sm:gap-3 font-Montserrat font-bold text-2xl xs:text-3xl sm:text-5xl">
